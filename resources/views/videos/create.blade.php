<x-app-layout>
    ...
    @csrf
                <div class="mb-6">
                    ...
                    <x-input id="title" placeholder="Masukan Title" type="text" class="block mt-1 w-full border-gray-300"  name="title" :value="old('title')" />
                    @error('title')<div class="text-red-500 mt-2">{{ $message }}</div>@enderror
                </div>

                <div class="mb-6">
                    <x-label for="unique_video_id" :value="__('Unique Code')" />
                    <x-input id="unique_video_id" placeholder="Masukan Unique Code" type="text" class="block mt-1 w-full border-gray-300"  name="unique_video_id" :value="old('unique_video_id')" />
                ...
                <div class="flex lg:-mx-2">
                    <div class="lg:px-2 w-full lg:w-1/2 mb-6">
                        <div class="mb-6">
                            ...
                            <x-input id="episode" placeholder="Masukan Episode" type="text" class="block mt-1 w-full border-gray-300"  name="episode" :value="old('episode')" />
                    ...
                    <div class="mb-6">
                        ...
                        <x-input id="runtime" placeholder="Masukan Runtime" type="text" class="block mt-1 w-full border-gray-300"  name="runtime" :value="old('runtime')" />
            ...
            <div class="mb-6">
                <label for="intro" class="flex">
                     <input type="checkbox" name="intro" id="intro" class="mr-2 focus:outline-none focus:ring-transparent text-blue-500 rounded border-gray-300">
